!(function (s, n) {
  ...
  function d(s, n) {
    for (
      var e = s < 0 ? 1 : 0, a = (s = Math.abs(s)), t = 0;
      s >= m[t] && t < m.length;
      t++
    )
      s /= m[t];
    return (
      (0 === (t *= 2) ? 9 : 1) < (s = Math.floor(s)) && (t += 1),
      n(s, t, a)[e].replace("%s", s.toString())
    );
  }
  function c(s, n) {
  ...
  var X = Object.freeze({
    ...
    ar: function (s, n) {
      ...
      var e,
        ...
        t =
          ((e = Math.floor(n / 2)),
          (a = s) < 3 ? b[e][a - 1] : 3 <= a && a <= 10 ? b[e][2] : b[e][3]);
      return ["منذ " + t, "بعد " + t];
    },
    be: function (s, n) {
      switch (n) {
    ...
    he: function (s, n) {
      return [
        ...
        ["לפני שעה", "בעוד שעה"],
        2 === s
          ? ["לפני שעתיים", "בעוד שעתיים"]
          : ["לפני %s שעות", "בעוד %s שעות"],
        ["אתמול", "מחר"],
        2 === s
          ? ["לפני יומיים", "בעוד יומיים"]
          : ["לפני %s ימים", "בעוד %s ימים"],
        ["לפני שבוע", "בעוד שבוע"],
        2 === s
          ? ["לפני שבועיים", "בעוד שבועיים"]
          : ["לפני %s שבועות", "בעוד %s שבועות"],
        ["לפני חודש", "בעוד חודש"],
        2 === s
          ? ["לפני חודשיים", "בעוד חודשיים"]
          : ["לפני %s חודשים", "בעוד %s חודשים"],
        ["לפני שנה", "בעוד שנה"],
        2 === s
          ? ["לפני שנתיים", "בעוד שנתיים"]
    ...
    ro: function (s, n) {
      ...
      return s < 20
        ? e[n]
        : [e[n][0].replace("%s", "%s de"), e[n][1].replace("%s", "%s de")];
    },
    ru: function (s, n) {
      switch (n) {
        case 0:
  ...
  Object.keys(X).forEach(function (s) {
    ...
    (s.register = u),
    (s.render = function (s, n, e) {
      var a = s.length ? s : [s];
      return (
        a.forEach(function (s) {
          p(s, s.getAttribute("datetime"), r(n), e || {});
        }),
        a
      );
    }),
